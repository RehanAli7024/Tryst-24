...
function GuestRegisteration({ handleClose, setRegistrationOpen }) {
  ...
  const handleNewFieldTitleChange = (e) => {
    setNewFieldTitle(e.target.value);
  };

  const handleNewFieldTypeChange = (type) => {
  ...
  const handleAddNewField = () => {
    ...
    setNewFieldTitle(''); // Reset the new field title
    setNewFieldType(''); // Reset the new field type
  ...
  return (
    <div className="registration-containor">
      ...
      {newFieldTitle && (
        <div className={`new-field-type-${newFieldType}`}>
          {newFieldType === 'text' && <p>{newFieldTitle}</p>}
          {newFieldType === 'radio' && <AddedFieldRadio additionalFieldData={{ fieldTitle: newFieldTitle }} />}
          {newFieldType === 'checkbox' && <AddedFieldCheckbox additionalFieldData={{ fieldTitle: newFieldTitle }} />}
          {newFieldType === 'upload' && <AddedFieldUpload additionalFieldData={{ fieldTitle: newFieldTitle }} />}
        </div>
      )}
  ...
  const handleSave = () => {
    ...
    const allResponses = [
      ...
      ...additionalFields.map((field) => ({
        fieldName:additionalFieldData.fieldTitle,
